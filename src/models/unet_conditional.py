...
class ConditionalUNet(nn.Module):
    ...
    def __init__(
        ...
        * `n_blocks` is the number of `UpDownBlocks` at each resolution
        ...
        self.time_emb = TimeEmbedding(time_embedding_channels)
...
class TimeEmbedding(nn.Module):
    ...
    def __init__(self, n_channels: int, act: nn.Module = nn.SiLU()):
        ...
        * `n_channels` is the number of dimensions in the embedding
        ...
        # devide the logarithmic scale up to 10_000 into 16 parts:
    ...
    def forward(self, t: torch.Tensor):
        ...
        phase = t.view(-1, 1) * self.FREQUENCY_SCALES  # [batch_size, half_dim]
